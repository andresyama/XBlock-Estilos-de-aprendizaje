...
class AdaptiveTestXBlock(XBlock):
    ...
    testNumber = Integer(
        default=7, scope=Scope.user_state_summary,
        help="Test number (0: Not avaliable, 1: Kolb, 2: Dominancia, 3:Inteligencias Multiples, 4:Honey-Alonso, 5:Felder Silverman, 6: Bandler & Grinder,7:Herrmann_v2",
    )
